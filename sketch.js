...
function preload() {
  ...
  rulesIMG = loadImage("rulesTextIMG.png")
...
function setup() {
  ...
  rules = createSprite(displayWidth/2 + 370, displayHeight*5);
  rules.shapeColor = "teal"
...
function draw() {
  ...
  if(runner.position.x === item1.position.x && runner.position.y === item1.position.y && item1.visible !== false){
    item1.visible = false
    item1.destroy();
  ...
  if(runner.position.x === item2.position.x && runner.position.y === item2.position.y && item2.visible !== false){
    item2.visible = false
    item2.destroy();
  ...
  if(runner.position.x === item3.position.x && runner.position.y === item3.position.y && item3.visible !== false){
    item3.visible = false
    item3.destroy();
  ...
  if(runner.position.x === item4.position.x && runner.position.y === item4.position.y && item4.visible !== false){
    item4.visible = false
    item4.destroy();
  ...
  if(runner.position.x === item5.position.x && runner.position.y === item5.position.y && item5.visible !== false){
    item5.visible = false
    item5.destroy();
  ...
  if(runner.position.x === item6.position.x && runner.position.y === item6.position.y && item6.visible !== false){
    item6.visible = false
    item6.destroy();
  ...
  if(runner.position.x === item7.position.x && runner.position.y === item7.position.y && item7.visible !== false){
    item7.visible = false
    item7.destroy();
  ...
  if(runner.position.x === item8.position.x && runner.position.y === item8.position.y && item8.visible !== false){
    item8.visible = false
    item8.destroy();
  ...
  if(runner.position.x === item9.position.x && runner.position.y === item9.position.y && item9.visible !== false){
    item9.visible = false
    item9.destroy();
  ...
  if(runner.position.x === item10.position.x && runner.position.y === item10.position.y && item10.visible !== false){
  ...
  if(runner.position.x === item11.position.x && runner.position.y === item11.position.y && item11.visible !== false){
  ...
  if(runner.position.x === item12.position.x && runner.position.y === item12.position.y && item12.visible !== false){  
...
if(gameState === 1){
  background("crimson");
  runner.position.x = displayWidth/2;
  runner.position.y = displayHeight*5 - 100;

  camera.position.x = runner.position.x;
  camera.position.y = runner.position.y;
	fill("white");
	textSize(30);
	text("Your Score is : " + score, runner.position.x - 400, runner.position.y);
}
